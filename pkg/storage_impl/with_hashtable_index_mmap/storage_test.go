...
func createWithHashTableIndexMmapStorage(t testing.TB, name string) (storage engine.StorageEngine, cleanRes func(), err error) {
...
func Test_WriteAndRead(t *testing.T) {
	storage, cleanRes, err := createWithHashTableIndexMmapStorage(t, "write_and_read_test")
	if err != nil {
		t.Error(err)
		return
	}
...
func Test_Delete(t *testing.T) {
	storage, cleanRes, err := createWithHashTableIndexMmapStorage(t, "delete_test")
	if err != nil {
		t.Error(err)
		return
	}
